...
namespace LGV.Interface_Layer
{
    public partial class Sales_Form  : Form
    {
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            if(id > 0)
            {
                try
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        db.SaveChanges();
                        toast.txt_caption.Text = "Vente a été supprimé";
                        toast.Show();                     
                        update_data();
                    }
                }
            ...
            {
                dialogue.txt_caption.Text = "Il n'y a aucune Vente à supprimer";
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            gridControl1.DataSource = db.TB_Sales.Where(x => x.Sale_Name.Contains(_search) ||
                                                            x.Sale_Client.Contains(_search)).ToList();
        }
    }
}
