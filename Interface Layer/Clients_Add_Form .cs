...
{
    public partial class Clients_Add_Form : Form
    {
        // Initialiser
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            if (edit_name.Text == "")
            {
                ...
                dialogue.txt_caption.Text = "Le nom du client est obligatoire";
                dialogue.Show();
            } 
            else
            {
                if (id == 0)
                {
                    ...
                    db.TB_Clients.Add(tb_supp);
                    db.SaveChanges();
                    toast.txt_caption.Text = "Un nouvelle client a été ajoutée";
                    toast.Show();
                ...
                else
                {
                    ...
                    db.SaveChanges();
                    toast.txt_caption.Text = "Le client a été modifiée";
                    toast.Show();
                    //db = new DB_LGVEntities();
                    //category_form.gridControl1.DataSource = db.TB_Category.ToList();
                    this.Close();
