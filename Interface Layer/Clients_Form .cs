...
namespace LGV.Interface_Layer
{
    public partial class Clients_Form : Form
    {
        ...
        TB_Clients tb_supp = new TB_Clients();
        ...
        public Clients_Form()
        {
            ...
            dbContext.TB_Clients.LoadAsync().ContinueWith(loadTask =>
            {
                // Bind data to control when loading complete
                gridControl1.DataSource = dbContext.TB_Clients.Local.ToBindingList();
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            if(id > 0)
            {
                try
                {
                    ...
                    {
                        tb_supp = db.TB_Clients.Where(x => x.ID == id).FirstOrDefault();
                        db.Entry(tb_supp).State = EntityState.Deleted;
                        toast.txt_caption.Text = "Client a été supprimé";
                        toast.Show();
                        db.SaveChanges();
                        update_data();
                    }
        ...
        private void update_data()
        {
            ...
            gridControl1.DataSource = db.TB_Clients.ToList();
        }
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            gridControl1.DataSource = db.TB_Clients.Where(x => x.Supp_Name.Contains(_search) ||
